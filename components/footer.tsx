      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
          ...
          <div className="text-center md:text-left">
            ...
            <h3 className="text-2xl md:text-3xl font-extralight leading-tight mb-4 md:mb-6">
              Encuentra la <br />
              felicidad y la <br />
              abundancia
            </h3>
          ...
          <div className="md:hidden grid grid-cols-2 gap-4 text-gray-2">
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="flex gap-3 flex-wrap">
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-gray-2 hover:text-white transition-colors"
                >
            ...
            <div className="flex flex-col items-end text-gray-2">
          ...
          <div className="md:hidden flex flex-col items-center mt-6">
            ...
            <Link href="/sobre-nosotros" className="text-gray-2 hover:text-white transition-colors text-sm mt-2">
              Sobre Nosotros
            </Link>
          </div>

          {/* Columna central - Contacto (solo desktop) */}
          <div className="hidden md:flex flex-col items-center text-gray-2">
            ...
            <div className="mt-6 md:mt-8 flex flex-col items-center gap-2">
              ...
              <Link
                href="/sobre-nosotros"
                className="text-gray-2 hover:text-white transition-colors text-sm md:text-base"
              >
                Sobre Nosotros
              </Link>
            </div>
          ...
          <div className="hidden md:flex flex-col items-center md:items-end text-gray-2">
        ...
        <div className="mt-8 pt-6 border-t border-gray-800 text-center">
          <p className="text-gray-2 text-sm">© 2025. Derechos Reservados "Optimizador".</p>
        </div>
      </div>
    </footer>
  )
