...
export default function SalesPage() {
  ...
  // Función para determinar si es pago QR (basado en datos de BD)
  ...
  const filterSales = () => {
    ...
    // Filtro por tipo de entrega (usando datos de BD directamente)
    ...
    try {
      const exportData = filteredSales.map((sale, index) => {
        ...
        return {
          ...
          // INFORMACIÓN DE ENVÍO (usando datos de BD)
    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600">Monitoreo en tiempo real de todas las ventas</p>
        </div>
                    ...
                    {filteredSales.map((sale) => (
                      <TableRow key={sale.id}>
                        ...
                        <TableCell>
                          ...
                          {sale.qrReference && (
                            <div className="text-sm text-gray-600">QR: {sale.qrReference}</div>
                          )}
                        </TableCell>
                        ...
                        <TableCell>{getDeliveryBadge(sale.deliveryType)}</TableCell>
                        <TableCell>
                          {sale.deliveryType === DeliveryType.PHYSICAL ? (
                            <div className="text-sm max-w-xs">
                              ...
                              {sale.address && (
                                <div className="text-gray-600 ml-4 break-words">
                                  🏠 {sale.address}
                                </div>
                              )}
                            </div>
                            ...
                            <div className="text-sm text-gray-500">
                              <div className="flex items-center">
                                <Monitor className="h-3 w-3 mr-1 text-blue-600" />
                                Entrega Digital
                              </div>
